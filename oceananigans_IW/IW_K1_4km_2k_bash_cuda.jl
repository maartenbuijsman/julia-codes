#= IW_K1_4km_2k_bash_cuda.jl
Maarten Buijsman, USM DMS, 2026-5-21
    05. series
    for mode 1 K1, dx=4km, L=2000km, 20days
    Amz stratification
...
#Ttide = (12 + 25.2 / 60) * 3600   # M2 tidal period, seconds
Ttide = 23.9344690195 * 3600       # K1  
...
pm = merge(pm, (Usur=[Usur1, Usur2], T=Ttide));
